...
INSERT INTO TABLE doctor_speicail (speicail_number,speicail_name) VALUES (1,heart),(2,ear)

INSERT INTO TABLE main_bill (main_bill_number,main_bill_date,detailed_bill_number) VALUES (1,12-12-1998,1),(2,12-12-1998,1)

INSERT INTO TABLE services (services_number,service_price,services_name) VALUES (1,200,CHECKing),(2,100,blood)

INSERT INTO TABLE take (ill_id,main_bill_number,department_number,take_number,take_time,take_state,take_resuilts,doctor_number) VALUES (1,1,2,1,12-11-1998,Active,high,1)
